    ...
    <section id="projects">
      ...
      <PDFPreview pdfUrl="resumeweb.pdf"/>
        ...
        <h2 class="sample-head">
                <a href="word-manual-381.pdf"> Using Microsoft Word for Engineers: Formatting a Test Report (PDF)</a>
            </h2>
            <div class="preview">
            <PDFPreview pdfUrl="word-manual-381.pdf"/>
            </div>
                <p class="portfolio-paragraph">
            ...
            <h2 class="portfolio-head">
                <a href="grant-proposal.pdf">Grant proposal for Ludlow Market Day (PDF)</a>
            </h2>
            <div class="preview">
            <PDFPreview pdfUrl="grant-proposal.pdf"/>
            </div>
                <p class="portfolio-paragraph">
            ...
            <h2 class="portfolio-head">
                <a href="internship-sample.pdf">Documentation for the UMass Center for Data Science and Red Cross project (PDF)</a>
            </h2>
            <div class="preview">
            <PDFPreview pdfUrl="internship-sample.pdf"/>
            </div>
